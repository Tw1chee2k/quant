    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        row.addEventListener('click', function() {
            ...
            activeRow = null;
            updateButtonStyle(false, false, false) 
            if (this.dataset.id) {
        ...
        function updateButtonStyle(agreedActive, controlActive, sentActive) {
        ...
        updateButtonStyle(activeAgreedRow !== null, activeAgreedRow !== null, activeAgreedRow !== null,);
        ...
        versionRows.forEach(function(row) {
            row.addEventListener('click', function() {
                ...
                if (isActive) {
                    ...
                    updateButtonStyle(false, false);
                } else {
                    this.classList.add('active-report_version');
                    activeAgreedRow = this;
                    updateButtonStyle(true, true, true);
                }
            });
        });
