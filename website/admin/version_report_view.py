...
class Version_reportView(ModelView):
    ...
    column_list = ['id', 'begin_time', 'change_time', 'control', 'agreed', 'sent', 'status', 'agreed_time', 'fio', 'telephone', 'email', 'report_id']
    column_default_sort = ('fio', True)
    column_sortable_list = ('id', 'begin_time', 'change_time', 'control', 'agreed', 'sent', 'status', 'agreed_time', 'fio', 'telephone', 'email', 'report_id')
    
    AVAILABLE_versions_TYPES = [
        (u'Заполнение', u'Заполнение'),
        (u'Контроль пройден', u'Контроль пройден'),
        (u'Согласовано', u'Согласовано'),
        (u'Отправлено', u'Отправлено'),  
