...
class Version_reportView(ModelView):
    ...
    column_list = ['id', 'begin_time', 'change_time', 'status', 'agreed_time', 'fio', 'telephone', 'email', 'report_id']
    column_default_sort = ('fio', True)
    column_sortable_list = ('id', 'begin_time', 'change_time', 'status', 'agreed_time', 'fio', 'telephone', 'email', 'report_id')
