...
class UserView(ModelView):
    ...
    column_list = ['id', 'type', 'email', 'password', 'fio', 'telephone', 'password', 'reports', 'organization', 'is_active', 'last_active']
    column_default_sort = ('fio', True)
    column_sortable_list = ('id', 'type', 'email', 'password', 'fio', 'telephone', 'password', 'reports', 'organization', 'is_active', 'last_active')
